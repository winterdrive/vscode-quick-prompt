...
export class McpConfigPanel {
    ...
    private _update() {
        ...
        this._panel.webview.html = this._getHtmlForWebview(toolConfigs, workspaceContext, serverPath, {
            ...
            skillTitle: 'Agent Skill',
            skillBody: 'Install the canonical QuickPrompt skill with the standard Agent Skills CLI: <code>npx skills add winterdrive/QuickPrompt</code>. Use this panel only for MCP client configuration.',
